...
leaving the long exact sequence that transports its top homology along the
syzygies of the minimal resolution. Everything else — the shift `e+3`, full support of the last
