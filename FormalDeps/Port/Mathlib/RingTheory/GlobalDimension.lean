...
public import FormalDeps.Port.Mathlib.Algebra.Category.ModuleCat.Baer
...
lemma globalDimension_eq_iSup_loclization_prime [Small.{v} R] [IsNoetherianRing R] :
  ...
  · simp only [globalDimension_eq_sup_projectiveDimension_finite, iSup_le_iff]
    intro M fin
    simp only [ModuleCat.projectiveDimension_eq_iSup_localizedModule_prime M, iSup_le_iff]
    intro p
  ...
  · simp only [iSup_le_iff, globalDimension]
    ...
    apply le_trans (le_trans _ (ModuleCat.projectiveDimension_le_projectiveDimension_of_isLocalizedModule
...
lemma globalDimension_eq_iSup_loclization_maximal [Small.{v} R] [IsNoetherianRing R] :
  ...
  · simp only [globalDimension_eq_sup_projectiveDimension_finite, iSup_le_iff]
    intro M fin
    simp only [ModuleCat.projectiveDimension_eq_iSup_localizedModule_maximal M, iSup_le_iff]
    intro p
    exact le_trans (le_iSup _ (M.localizedModule p.asIdeal.primeCompl))
